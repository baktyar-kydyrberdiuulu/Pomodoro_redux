  ...
  return (
    <div>
      ...
      <Info active={info} onChange={onInfo}>
        <h2>About Peaksoft school</h2>
        We started our studies at the beginning of November. When we started we had 180 students.
        Then they slowly left and only 22 students remained at the end of the course.
        Our main thing is not quantity but quality. Our students are the smartest and most diligent.
        Our teacher is <b>Akmaral</b>.
        She is beautiful and smart, knows her job, does everything professionally. We love her.

        <p><b>Peaksoft House JS-Group Akmaral</b></p>
        <i><b>Best regards, your beloved student Baktyiar Kydyrberdi uulu</b></i>
        <p>Bishkek  <b>2021.06.30</b></p>
        <br />
        <br />
        <Button
          variant='outlined'
